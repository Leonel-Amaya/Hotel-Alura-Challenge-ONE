...
//	     String Contraseña="admin";
		//Implementación propia
	     ...
	     EntityManagerFactory factory = Persistence.createEntityManagerFactory("pruebahotel");
			...
			try {
				LoginModelo consultarLogin = loginDao.consultarLogin(usuario, contrasena);
				System.out.println(consultarLogin);
				if(consultarLogin != null) {
					System.out.println("El registro existe");
					JOptionPane.showMessageDialog(null, "El usuario existe. Puede acceder");
				...
				JOptionPane.showMessageDialog(null, "El usuario o contraseña no válidos");
			}
			
			em.close();
			System.out.println("Se cerró");
	     	//Método dado por la interfaz suministrada
